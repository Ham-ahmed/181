...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing  levi45-freeserver_2.2    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/181/refs/heads/main/enigma2-plugin-extensions-levi45multicammanager_10.2-r5_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45multicammanager_10.2-r5_all.ipk"
