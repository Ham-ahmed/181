...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/181/refs/heads/main/channels_backup_OpenBlackhole_20251230_HAZEMWAHBA-CIEFP.tar.gz"
