...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing  levi45-settings_1.5    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/181/refs/heads/main/enigma2-plugin-extensions-levi45-settings_1.5_all.ipk"
IPK_NAME="enigma2-plugin-extensions-levi45-settings_1.5_all.ipk"
