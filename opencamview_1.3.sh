...
echo -e "${CYAN}"
echo "################################################################"
echo "#       Start downloading and installing  opencamview_1.3      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/181/refs/heads/main/enigma2-plugin-extensions-opencamview_1.3_all.ipk"
IPK_NAME="enigma2-plugin-extensions-opencamview_1.3_all.ipk"
